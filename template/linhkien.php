...
<html lang="vi">
    ...
    <body style="background-color: #F1F1F1;">
        ...
        <section class="brandpk">
            <article><a href="#link" target="_blank"><img src="img/brand/adata.png" style="width:50%"></a></article>
            <article><a href="#link" target="_blank"><img src="img/brand/kingston.png" style="width:90%"></a></article>
            <article><a href="#link" target="_blank"><img src="img/brand/Intel.png" style="width:42%"></a></article>
            <article><a href="#link" target="_blank"><img src="img/brand/Crucial.png" style="width:90%"></a></article>
            <article><a href="#link" target="_blank"><img src="img/brand/gigabyte.png" style="width:100%"></a></article>
            <article><a href="#link" target="_blank"><img src="img/brand/samsung.png" style="width: 95%"></a></article>
            <article><a href="#link" target="_blank"><img src="img/brand/SanDisk.png" style="width: 90%"></a></article>  
        </section>
        ...
        <div class="container">
            ...
            <p class="linkk" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px;">
                <a href="index.php?task=pagehome">Trang chủ</a> > 
                <a href="index.php?task=sanpham"> Sản phẩm</a> > Linh kiện
            </p>
        </div>
        ...
        <?php
        foreach($laysplinhkien as $values){ 
            ?>      
            <article>
