    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?task=giohang"><i class="fa fa-user-circle" aria-hidden="true"></i> Quản Lý Giỏ Hàng</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="index.php?task=giohang" data-toggle="tooltip" data-placement="bottom" title="Giỏ Hàng">Giỏ Hàng</a></li>
                    <li>
                        ...
                        <ul class="dropdown">
                            ...
                            <?php
                                if(isset( $_SESSION['level'])){
                                    ...
                                    echo "<a href='index.php?task=pageuser'> Về Trang Chủ</a>";
                                }
                                else{
                               ?>
    ...
    <div class="container-fluid al">
        ...
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
               ...
               <?php
               $tong=0;
                foreach($hienthigiohang as $values){
                    if($_SESSION['id']==$values['id_user']){      
               ?> 
                <tr> 
                    <td>  
                        <?php
                    ...
                    <td>
                        <img src="upload/<?php echo $values['anh'] ?>" alt="">
                    </td>
                    <td>
                    <?php
                    ...
                    <td>
                        <?php
                        $thanhtien=$values['soluong']*$values['giaban'];
                        $tong=$tong+$thanhtien;
                        echo number_format($thanhtien, 0, ',', '.'). ' VND';
                        ?>
                    </td>
                    <td>
                    <a href="index.php?task=xoagiohang&id_gh=<?php echo $values['id_gh'] ?>">Xóa</a>
                    </td>
                    <?php
...
<?php    
                        ...
                        elseif(!isset($_SESSION['level'])||$_SESSION['level']!=1){ 
                            ...
                            ?>
                            <p>Đăng Nhập</p><a href="index.php?task=pagelogin">Tại Đây</a>
                            <?php
                        }
                           ?>