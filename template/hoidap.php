    ...
    <body style="background-color: #F1F1F1;">
        ...
        <div class="container">
            ...
            <p class="linkk" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px;">
                <a href="index.php?task=pagehome">Trang chủ</a> > Hỏi đáp
            </p>
        </div>
        ...
        <center>
            <h1 style="font-family: 'Open Sans', sans-serif; text-align: center; color: lightseagreen; font-size: 24px;">LIÊN HỆ VỚI CHÚNG TÔI</h1>
            <P1 style="font-family: 'Open Sans', sans-serif; text-align: center; color: black;">Nếu bạn có thắc mắc cần giải đáp, hãy liên hệ với chúng tôi ngay!</P1>
        </center>
        <section class="hovaten">
            <article>
                <p style="color: black; text-align: left; padding-left: 6em; font-size: 17px; font-family: 'Open Sans', sans-serif;"><i class="fas fa-map-marker-alt" style="color: black; font-size: 20-px;"></i> <strong style="color: black;">Địa chỉ:</strong> </p>
                <p style="color: black; text-align: left; padding-left: 6em; font-size: 17px; font-family: 'Open Sans', sans-serif;"><i class="fas fa-phone" style="color: black; font-size: 20-px;"></i> <strong style="color: black;">Điện thoại:</strong>0332651691</p>
                <p style="color: black; text-align: left; padding-left: 6em; font-size: 17px; font-family: 'Open Sans', sans-serif;"><i class="fas fa-envelope" style="color: black; font-size: 20-px;"></i> <strong style="color: black;">Mail:</strong> thegioiso@gmail.com</p>
            </article>
            <article>
            <form method="POST" action="">
                ...
                ?>
                <input type="hidden" name="id_tk" value ="<?php echo $_SESSION['id'];?>">
                <?php
                }
                ?>
                <li style="list-style-type: none; padding-top: 1em;">
                        <input type="hovaten" name="hoten" placeholder="Họ và Tên" align="middle">
                </li>
                <li style="list-style-type: none; padding-top: 1em;">
                        <input type="hovaten" name="sdt" placeholder="Số Điện Thoại" align="middle">
                </li>
                <li style="list-style-type: none; padding-top: 1em;">
                        <input type="hovaten" name="email" placeholder="Email" align="middle">
                </li>
                <li style="list-style-type: none; padding-top: 1em;">
                        <textarea style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 17px;" type="noidung" name="nd" placeholder="Nội dung" align="middle"></textarea>                
                </li>
                <li style="list-style-type: none; padding-top: 1em;">
                    <center><button class="button-btn" name="hoidap" type="submit">Gửi</button></center>
                </li>
            </form>
            </article>
        </section>
