    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?task=qlsanpham"><i class="fa fa-user-circle" aria-hidden="true"></i> Quản Lý Sản Phẩm</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="index.php?task=pageadmin" data-toggle="tooltip" data-placement="bottom" title="TÀI KHOẢN">TÀI KHOẢN</a></li>
                    <li class="active"><a href="index.php?task=qlsanpham" data-toggle="tooltip" data-placement="bottom"
        ...
        <table class="table table-bordered" id="myTable">
            <thead>
                ...
                <tr class="ex">
                    ...
                    <th>Loại Sản Phẩm</th>
                    <th>Ảnh Sản Phẩm</th>
                    <th>Giá Mua Vào(VND)</th>
                    <th>Giá Bán Ra(VND)</th>
                    <th>Sửa,Xóa</th>
                    <th><a href="index.php?task=themsp" style="color:black;">Thêm Sản Phẩm</a></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        <img style="border: 1px; width: 100px;" src="upload/<?php echo $values['anh'];?>"> 
                    </td>
                    <td>
                        <?php
                        echo number_format($values['giamua'], 0, ',', '.'). ' VND';
                        ;
                        ?>
                    </td>
                    <td>
                        ...
                        echo number_format($values['giaban'], 0, ',', '.'). ' VND';
                        ?>
                    </td>
                    <td><a href="index.php?task=suasp&id_sp=<?php echo $values['id_sp'];?>">SỬA</a>
                        <a href="index.php?task=xoasp&id_sp2=<?php echo $values['id_sp'];?>">XÓA</a>
                    </td>
                </tr>
               <?php
                }
